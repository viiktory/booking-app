          ...
          <Form className={styles.formContainer}>
            <div className={styles.fieldsContainer}>
              <div className={styles.fieldGroup}>
                ...
                <Field as="select" name="location" className={styles.select}>
...
"
              ...
              <div className={styles.fieldGroup}>
                ...
                <Field type="date" name="checkIn" className={styles.input} />
                <ErrorMessage name="checkIn" component="div" className={styles.errorMessage} />
              </div>
              <div className={styles.fieldGroup}>
                <label>Check-out Date:</label>
                <Field type="date" name="checkOut" className={styles.input} />
                <ErrorMessage name="checkOut" component="div" className={styles.errorMessage} />
              </div>
              <div className={styles.fieldGroup}>
                <label>Number of Guests:</label>
                <Field type="number" name="guests" min="1" className={styles.input} />
                <ErrorMessage name="guests" component="div" className={styles.errorMessage} />
              </div>
              <div className={styles.fieldGroup}>
                <label>Hotel Rating:</label>
                <Field as="select" name="rating" className={styles.select}>
              ...
              <div className={styles.checkboxGroup}>
                ...
                <ErrorMessage name="hasWebsite" component="div" className={styles.errorMessage} />
              </div>
            </div>
