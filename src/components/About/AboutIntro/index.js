      ...
      <div className={styles.container}>
        <div className={styles.textWrapper}>
          ...
          <p className={styles.descriptionText}>
            Start Over was founded by a group of travel enthusiasts who recognized the need for a
        ...
        <div className={styles.imageGrid}>
          <div className={styles.topImages}>
            <img className={styles.image} src={team} alt="Team working together" />
            <img className={styles.image} src={handsTeam} alt="Team collaborating" />
          </div>
          <div className={styles.bottomImages}>
            <img className={styles.image} src={colleagues} alt="Colleagues brainstorming" />
          </div>
        </div>
      </div>
    </section>
