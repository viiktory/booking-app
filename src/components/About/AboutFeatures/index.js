...
const features = [
  {
    ...
    description: 'Fast and efficient bookings with a simple and user-friendly design.',
  },
  {
    id: 2,
    icon: <FaHotel className={styles.icon} />,
    title: 'Wide Range of Hotels',
    description: 'Access to hotels of all kinds, from luxury stays to budget-friendly options.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: 'Tailored suggestions based on your preferences and past choices.',
  },
];
